...
import { Control, FieldError, FieldPathValue, FieldPathWithValue, FieldValues, IsAny, NestedValue, Primitive, RefCallBack, UnpackNestedValue, UseFormStateReturn } from './';
declare type ControllerFieldError<TFieldValues extends FieldValues = FieldValues, TResult = any, TName extends FieldPathWithValue<TFieldValues, TResult> = FieldPathWithValue<TFieldValues, TResult>, FieldValuesAtPath = IsAny<TResult> extends true ? FieldPathValue<TFieldValues, TName> : TResult> = FieldValuesAtPath extends NestedValue | Primitive ? FieldError : FieldErrors<FieldValuesAtPath>;
